...
let texto = prompt('Ingresa un texto corto: ');
console.log(texto.length);
alert('viviste un total de ' + edad*365 + ' Dias, al cumplir los 18');
let num1 = prompt('Ingresa dos valores a sumar porfavor: ');
let num2 = prompt();
console.log(Number(num1) + Number(num2)); 
let edadmax = prompt('Hasta cuanto queres vivir?')
let snack = prompt('Cual es tu snack favorito?')
let preciosnack = prompt('Y cuanto salen?')
let snackdiarios = prompt('cuantos ' + snack + ' comes por dia?')
let edadres = edadmax - edad
console.log(edadres)
